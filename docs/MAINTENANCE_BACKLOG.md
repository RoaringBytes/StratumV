...
| 3 | Test-coverage gap scan | M | in-progress | 2026-07-03 scan (by header inclusion, not filename): pure-logic modules with NO test coverage: WorldStateIO, SceneStatePersistence, InputBindings, InputAction, ReplicationProtocol, MorphTargetTypes. This PR adds test_SceneStateVersioning.cpp (11 cases: migration chains/ordering/skips, backup files, range clamping, game-registered ranges). Sha256/NetTransform/ParentLink already covered inside other test TUs. Continue with WorldStateIO next run. |
